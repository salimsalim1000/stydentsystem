...
urlpatterns = [
    ...
    path('add_course_save' , HodViews.add_course_save ,name="add_staff_save"),
    ...
    path('edit_course/<str:cours_id>', HodViews.edit_course, name="edit_course"),
...
#staff
    ...
    path('staff_aplly_leave', StaffViews.staff_aplly_leave, name="staff_aplly_leave"),
    path('staff_aplly_leave_save', StaffViews.staff_aplly_leave_save, name="staff_aplly_leave_save"),
